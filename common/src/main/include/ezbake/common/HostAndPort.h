...
#ifndef EZBAKE_COMMON_HOSTANDPORT_H_
#define EZBAKE_COMMON_HOSTANDPORT_H_
...
namespace ezbake { namespace common {
...
}} //namespace ::ezbake::common

#endif /* EZBAKE_COMMON_HOSTANDPORT_H_ */
