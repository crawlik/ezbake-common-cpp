...
public:
     ...
     */
    ThriftClientPoolBase(const ::ezbake::configuration::EZConfiguration& configuration,
     ...
     */
    virtual ::boost::shared_ptr< ::ezbake::configuration::helpers::ApplicationConfiguration> getAppConfiguration() const {
        return _appConfig;
    }
     ...
     */
    virtual ::boost::shared_ptr< ::ezbake::configuration::helpers::SecurityConfiguration> getSecurityConfiguration() const {
     ...
     */
    virtual ::boost::shared_ptr< ::ezbake::configuration::helpers::ThriftConfiguration> getThriftConfiguration() const {
     ...
     */
    virtual ::boost::shared_ptr< ::ezbake::configuration::helpers::ZookeeperConfiguration> getZookeeperConfiguration() const {
        return _zkConfig;
    }
...
protected:
    ...
    ::boost::shared_ptr< ::ezbake::configuration::helpers::SecurityConfiguration> _securityConfig;
    ::boost::shared_ptr< ::ezbake::configuration::helpers::ThriftConfiguration> _thriftConfig;
    ::boost::shared_ptr< ::ezbake::configuration::helpers::ZookeeperConfiguration> _zkConfig;
